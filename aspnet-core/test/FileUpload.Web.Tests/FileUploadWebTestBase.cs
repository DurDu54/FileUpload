...
{
    public abstract class FileUploadWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FileUploadWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FileUploadWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FileUploadDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FileUploadDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FileUploadDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FileUploadDbContext, Task<T>> func)
        {
            T result;
