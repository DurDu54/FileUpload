...
@Injectable()
export class FileUploadServiceServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    delete(fileName: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/FileUploadService/Delete?";
        if (fileName === null)
    ...
    getFiles(): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/FileUploadService/GetFiles";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetFiles(response: HttpResponseBase): Observable<string[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    hasFile(fileName: string | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/FileUploadService/HasFile?";
        if (fileName === null)
            throw new Error("The parameter 'fileName' cannot be null.");
        else if (fileName !== undefined)
            url_ += "fileName=" + encodeURIComponent("" + fileName) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processHasFile(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processHasFile(response_ as any);
                } catch (e) {
    ...
    protected processHasFile(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    upload(files: FileParameter[] | undefined): Observable<StringStringValueTuple[]> {
        let url_ = this.baseUrl + "/api/services/app/FileUploadService/Upload";
        url_ = url_.replace(/[?&]$/, "");
